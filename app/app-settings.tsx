...
export default function AppSettings() {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: bg }]}>
      ...
      {/* PREVIEW */}
      <View style={[styles.previewBox, { backgroundColor: cardBg, borderColor }]}>
        <Text style={[styles.previewTitle, { color: accentColor, fontSize: fs + 4 }]}>Preview</Text>
      ...
      <View style={[styles.card, { backgroundColor: cardBg, borderColor }]}>
        {THEMES.map(t => (
          ...
          >
            ...
            <Text style={[styles.themeLabel, { color: textColor, fontSize: fs }]}>{t.emoji}  {t.label}</Text>
        ...
        <View style={styles.fontRow}>
          {FONT_SIZES.map(f => (
            ...
            >
              ...
              {fontSize === f.key && <Ionicons name="checkmark-circle" size={14} color="#1D9E75" style={styles.fontCheck} />}
            </TouchableOpacity>
          ))}
        </View>
        <View style={[styles.fontPreview, { backgroundColor: isLight ? '#f0f4f8' : '#001f4d', borderColor }]}>
          ...
          Alert.alert('Reset Settings', 'Reset all personal settings to default?', [
            { text: 'Cancel', style: 'cancel' },
            {
              text: 'Reset', style: 'destructive', onPress: async () => {
                ...
                setNotifSound(true); setCompactCards(false); setVibration(true);
...
const styles = StyleSheet.create({
  ...
  previewBox: { margin: 16, marginBottom: 8, padding: 16, borderRadius: 14, borderWidth: 1 },
  ...
  themeLabel: { flex: 1, fontWeight: '600' },
  ...
  fontCheck: { position: 'absolute', top: 4, right: 4 },
  fontPreview: { padding: 12, borderRadius: 10, borderWidth: 1, alignItems: 'center' },
